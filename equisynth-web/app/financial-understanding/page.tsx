			...
			<div className="max-w-7xl mx-auto px-4 py-8">
				...
				<div className="text-center mb-10">
					...
					<p className="text-lg text-gray-600">
						Parse financial statements, extract metrics, and analyze narratives with AI
					</p>
				</div>
				...
				<div className="bg-white rounded-xl shadow-lg p-8 mb-8 border border-gray-200">
					<form onSubmit={fetchFiling} className="space-y-6">
						...
						<button
							type="submit"
							className="w-full px-6 py-4 rounded-lg bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-lg font-semibold hover:from-indigo-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-md hover:shadow-xl"
							disabled={loading}
						>
							{loading ? (
